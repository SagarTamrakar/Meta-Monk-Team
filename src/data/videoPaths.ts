...
export const VIDEO_PATHS = {
  ...
  threeDAnimation: [
    {
      video: "/3D ANIMATION/Gaming 1.mp4",
    ...
    {
      video: "/3D ANIMATION/Gaming 2.mp4",
      category: VIDEO_CATEGORIES["3D_ANIMATION"],
  ...
  cgiVfx: [
    {
      video: "/CGI AND VFX/1st VFX CHALANGE OUTPUT.mp4",
    ...
    {
      video: "/CGI AND VFX/2nd Desert Trailor Night.mp4",
      category: VIDEO_CATEGORIES.CGI_VFX,
    ...
    {
      video: "/CGI AND VFX/3rd Jungle.mp4",
      category: VIDEO_CATEGORIES.CGI_VFX,
    ...
    {
      video: "/CGI AND VFX/4th Japanese Village.mp4",
      category: VIDEO_CATEGORIES.CGI_VFX,
    ...
    {
      video: "/CGI AND VFX/5th Desert Trailor.mp4",
      category: VIDEO_CATEGORIES.CGI_VFX,
  ...
  videoEditing: [
    ...
    {
      video: "/VIDEO EDITING/Copy Of Cafe Comercial.mp4",
      category: VIDEO_CATEGORIES.VIDEO_EDITING,
    ...
    {
      video: "/VIDEO EDITING/Copy Of Comercail Add.mp4",
      category: VIDEO_CATEGORIES.VIDEO_EDITING,
      title: "Commercial Ad",
    ...
    {
      video: "/VIDEO EDITING/Copy Of Comercial Add.mp4",
      category: VIDEO_CATEGORIES.VIDEO_EDITING,
    ...
    {
      video: "/VIDEO EDITING/Copy Of Comercial Shoes.mp4",
      category: VIDEO_CATEGORIES.VIDEO_EDITING,
    ...
    {
      video: "/VIDEO EDITING/Copy Of Img 1954.mp4",
      category: VIDEO_CATEGORIES.VIDEO_EDITING,
    ...
    {
      video: "/VIDEO EDITING/Copy Of Img 5113.mp4",
      category: VIDEO_CATEGORIES.VIDEO_EDITING,
    ...
    {
      video: "/VIDEO EDITING/Copy Of Prewed Teaser.mp4",
      category: VIDEO_CATEGORIES.VIDEO_EDITING,
      title: "Prewed Teaser",
