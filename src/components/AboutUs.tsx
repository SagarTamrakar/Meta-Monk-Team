    ...
    return (
        <div className="container mx-auto px-4 py-16 border-primary/20 border-2 rounded-lg bg-transparent backdrop-blur-sm">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-2 text-gray-600 ">
                <p className=" text-lg font-semibold mt-4">Founder & COO: Anmol Sharma</p>
                <p className=" text-lg font-semibold mt-4">Co-Founder & CEO: Mudit Gupta</p>
                <p className=" text-lg font-semibold mt-4">Co-Founder & CTO: Sagar Tamrakar</p>
                <p className=" text-lg font-semibold mt-4">MD: Abhinandan Sharma</p>
            </div>
        </div>
    );
}
