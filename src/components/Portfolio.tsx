...
export default function Portfolio() {
  const [selectedCategory, setSelectedCategory] = useState<string>(VIDEO_CATEGORIES.MOTION_GRAPHICS);
  ...
  const categories = [
    ...
    { name: VIDEO_CATEGORIES["3D_ANIMATION"], label: "3D Animation", color: "from-secondary to-cyan-400" },
    { name: VIDEO_CATEGORIES.CGI_VFX, label: "CGI & VFX", color: "from-purple-500 to-pink-500" },
    { name: VIDEO_CATEGORIES.VIDEO_EDITING, label: "Video Editing", color: "from-green-500 to-emerald-400" },
  ];

  return (
    <section className="py-24 px-6 relative z-100">
        ...
        >
          {categories.map((cat, idx) => (
            <motion.button
              ...
              className={`relative px-6 py-3 rounded-full font-heading font-bold text-sm tracking-wider uppercase transition-all duration-300 ${
